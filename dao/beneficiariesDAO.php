    ...
    public function salvar($beneficiaries)
    {
        ...
        try {
            if ($beneficiaries->getIdBeneficiaries() != "") {
                $statement = $pdo->prepare("UPDATE tb_beneficiaries SET str_nis=:str_nis,
 str_name_person=:str_name_person, str_cpf=:str_cpf, int_rgp=:int_rgp WHERE id_beneficiaries = :id;");
